...
let endpoint = '/data_source/10497/action/10503/mappings?version_id=10687&map_type=dimension&scenario_id=13146';

export default function () {
    const url = `http://127.0.0.1:5000/${endpoint}`;

    const headers = {
        'Authorization': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxMDE1NiwiZXhwIjoxNzEzNzgxMjMwfQ.zVwCp49Rkj6lHCWRpqn0aIxsRZN2zlWHBN-n4ttnaAQ',
